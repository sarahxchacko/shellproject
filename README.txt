...
Compilation:
  Used this compilation line: gcc -std=c99 proj1code.c -o proj1code
  Executed the file using this line: ./proj1code

  To compile and run this project, we used Powershell and created the C 
  code directly in our directory using the cat command.
      i.e.: cat > proj1code.c
